...
eval_words = ['hospital', 'cancer', 'procedure', 'patient']

# Word2Vec Parameters
embedding_size = 200 # Dimension of the embedding vector
max_vocabulary_size = 5748 # Total number of different words in the vocabulary
...
text_words = pd.read_csv('descriptions.txt', sep = '\n')
text_words = text_words.values.tolist()
corpus = []
for i in range(len(text_words)):
        corpus.append(text_words[i][0].lower())
corpus = " ".join(corpus)
text_words = corpus.split()
